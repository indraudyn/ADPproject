    ...
    <div class="content flex-fill">
        ...
        <div class="container-fluid mt-4">
            <div class="d-flex align-items-center mb-4">
                <a href="{{ route('audio.upload') }}" class="back-btn">
            ...
            <div class="card create-card">
                <div class="card-body">
                    ...
                    <form action="{{ route('audio.storeUser') }}" method="POST" enctype="multipart/form-data" id="audioForm">
                        @csrf
                        ...
                        <div class="text-end">
                            <button type="submit" class="btn btn-upload px-5">
                                Upload Audio <i class="bi bi-music-note-beamed ms-1"></i>
                            </button>
                        </div>
                    </form>
