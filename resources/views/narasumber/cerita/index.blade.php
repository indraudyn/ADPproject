...
<head>
    <meta charset="UTF-8">
    <title>Manajemen Cerita (Narasumber)</title>
    ...
    <div class="content flex-fill">
        ...
        <div class="container-fluid mt-4">
            ...
            <div class="page-header">
                <h3>Management Cerita (Narasumber)</h3>

                <div class="header-action d-flex gap-2">
                    <form action="{{ route('narasumber.cerita.index') }}" method="GET">
                    ...
                    <a href="{{ route('cerita.create') }}" class="btn btn-danger btn-create">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="{{ route('narasumber.cerita.edit', $cerita->id) }}" class="btn btn-sm btn-outline-primary me-2" title="Edit">
