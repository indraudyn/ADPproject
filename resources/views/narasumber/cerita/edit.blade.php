        ...
        <div class="container mt-4">
            <div class="card shadow-sm border-0 rounded-3">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('narasumber.cerita.update', $cerita->id) }}" method="POST" id="editNarasumberForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                            {{-- PILIH PARWA (berdasarkan book name dari API) --}}
                            <div class="col-md-6">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('narasumber.cerita.index') }}" class="btn btn-outline-secondary px-4">
                                Batal
                            </a>
...
<script>
    ...
    document.getElementById('editNarasumberForm').addEventListener('submit', function () {
