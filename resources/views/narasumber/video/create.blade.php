...
<head>
    <meta charset="UTF-8">
    <title>Upload Video (Narasumber)</title>
        ...
        <div class="container-fluid mt-4">
            ...
            <div class="card create-card">
                <div class="card-body">
                    ...
                    <form action="{{ route('narasumber.video.store') }}" method="POST" enctype="multipart/form-data" id="videoForm">
                        @csrf
                        ...
                        <div class="text-end">
                            <button type="submit" class="btn btn-upload px-5">
                                Upload Video <i class="bi bi-send ms-1"></i>
                            </button>
                        </div>
                    </form>
