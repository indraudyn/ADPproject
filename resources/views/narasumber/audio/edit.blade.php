...
<head>
    <meta charset="UTF-8">
    <title>Edit Audio (Narasumber)</title>
    ...
    <div class="content flex-fill">
        ...
        <div class="container-fluid mt-4">
            <div class="d-flex align-items-center mb-4">
                <a href="{{ route('narasumber.audio.index') }}" class="back-btn">
            ...
            <div class="card create-card">
                <div class="card-body">
                    ...
                    <form action="{{ route('narasumber.audio.update', $audio->id) }}" method="POST" enctype="multipart/form-data" id="audioForm">
                        @csrf
                        @method('PUT')
