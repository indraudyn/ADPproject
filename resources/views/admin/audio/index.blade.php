        ...
        <div class="container-fluid mt-4">
            ...
            <div class="page-header">
                ...
                <div class="header-action">
                    ...
                    <a href="{{ route('admin.audio.create') }}" class="btn btn-danger btn-create d-flex align-items-center gap-2 text-decoration-none">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('admin.audio.updateStatus', $audio->id) }}" method="POST" class="status-form">
                                    @csrf
                                    @method('PUT')
                            ...
                            <td class="text-end">
                                <a href="{{ route('admin.audio.edit', $audio->id) }}" class="btn btn-sm btn-outline-primary me-1" title="Edit">
                                    <i class="bi bi-pencil-square"></i>
                                </a>
                                <form id="delete-form-{{ $audio->id }}" action="{{ route('admin.audio.destroy', $audio->id) }}" method="POST" style="display:none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
