...
class VideoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->type == 'upload' && $request->hasFile('video_file')) {
            ...
            return redirect()->route('admin.video.index')->with('success', 'Video berhasil ditambahkan dan sedang diproses untuk optimasi (faststart)!');
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->type == 'upload' && $request->hasFile('video_file')) {
            \App\Jobs\OptimizeVideo::dispatch($video);
            return redirect()->route('admin.video.index')->with('success', 'Video berhasil diperbarui dan sedang diproses untuk optimasi!');
        }
